...
function MuonSysModule(name,srvMode,manifest){
    ...
    Object.defineProperty(this,'path',{value: sys.path});
...
function loadMode(mode,path){
    ...
    modeFile.reduce(function(p,moduleName){
        promise = p.then(_.partial(loadModule,moduleName,mode)).fail(function(e){
...
function loadModule(moduleName,srvMode){
    ...
    if (!fs.existsSync()) modulePath = sys.path+"/lib/modules/"+moduleName+"/module.js";
