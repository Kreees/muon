var app = require("express")(),
    ...
    less_prepare = m.sys.require("/utils/templates/less_prepare");


function less_render(path,_,callback){
    less.render(less_prepare.prepare(fs.readFileSync(path,"utf-8")),callback);
}
