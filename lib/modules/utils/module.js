    ...
    return {
        ...
        processTraceStack: function(fileName,offset){
            ...
            err.stack.split("\n").slice(1).forEach(function(it){
                ...
                if (it.indexOf(path.normalize(self.syspath+"/node_modules/")) != -1) return;
                if (it.indexOf(path.normalize(self.syspath+"/lib/sys")) != -1) return;
        ...
        __public__: function(){
            ...
            Object.defineProperty(obj,"fsExt",{value: fsExt});
            return obj;
        }
    };
}
