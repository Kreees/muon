...
module.exports = function(self,deps){
    ...
    return {
        ...
        normalizeDescriptor: self.require("lib/normalizeDescriptor"),
        registerDescriptor: function(modelName,descriptor){
            descriptors[modelName] = descriptor;  
        },
        getFullModelName: function(name,plugin){
            plugin = plugin || "";
            return ((plugin?plugin+":":"")+name);
        },
        getDescriptor: function(modelName){
            return descriptors[modelName];
        },
