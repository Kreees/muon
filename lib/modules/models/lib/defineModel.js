module.exports = function(self,deps){
    ...
    var hasOneAssociationWaiting = {};
    var hasManyAssociationWaiting = {};

    function putToAssociationWait(target,assoc,refName,descriptor){
        if (typeof assoc != "string") throw Error("Association name should be a string");
        if (!(target[assoc] instanceof Array)) target[assoc] = [];
        target[assoc].push({refName: refName,descriptor: descriptor});
    }
    ...
    return function(name,_descriptor,cfg){
        ...
        deps.database.getDatabase(descriptor.dbName).then(function(db){
