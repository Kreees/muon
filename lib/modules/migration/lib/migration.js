...
//TODO       
    ...
    function beforeMagic(){
        //sync added models and attributes
        return Q();
    }
    function afterMagic(){ //TODO удалить таблицы ненужных отношений 
    ...
    return {
        __init__ : function() {
            ...
            prms = prms.then(function(){ // load last state
                var dfd = Q.defer();
                ...
                State.find().last(function(err, item) {
                    ...
                    if (item && item.state_id) {
                        ...
                        currentState = new State({state_id: new Date().getTime()});
