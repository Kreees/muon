        ...
        run: function(id){
            ...
            prms = prms.then(function(){
               ...
               return Q();
                ...
                if(_.keys(diff.addModel).length == 0 && _.keys(diff.addModelAttributes).length == 0){
                ...
                if(_.keys(diff.rmModel).length == 0 && _.keys(diff.rmModelAttributes).length == 0 ){
                    if(dbg) console.log("No models and attributes to remove.");
                    return Q();
                } 
