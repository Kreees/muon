...
function baseSerializer(obj){
    var model;
    var ret;
    if (obj instanceof Array && obj[0]) model = m.models[obj[0].__modelName__];
    else model = m.models[obj.__modelName__];
    if (!model) return obj;
    var attrList = m._.keys(model);
    if (obj instanceof Array) {
        ret = obj.map(function(obj){
            var ret = {};
