...
function getServerHandler(){
    return {
        compileClient: m.__require__("/client/client_render"),
        compileMuonJs: m.__require__("/client/muon_render"),
        packageRender: m.__require__("/client/package_render"),
        packageView: m.__require__("/client/package_view"),
        packageTranslation: m.__require__("/client/package_translation"),
        apiProc: m.__require__("/router/api_router").run
    };
}
...
serverHandler.listen = function(port,host){
    ...
    return http.createServer(app).listen(m.cfg.port,m.cfg.host);
};
