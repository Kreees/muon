...
describe('MODELS module', function(){
    ...
    it('should return a scope with "User" model instance', function(done){
        this.module.init(this.cfg).done(function(scope){
            ...
            User.should.ownProperty("objectsList");
            User.should.ownProperty("scopes");
            User.should.ownProperty("scopesList");
...
//            objectsList
            ...
            User.objectsList.should.be.instanceOf(Array,"objectsList should be a list of objects name defined from descriptor");
            User.objectsList.should.be.eql(_.keys(User.objects),"objectsList should be an array of obj1/2/3");
...
//            scopesList
            ...
            User.scopesList.should.be.instanceOf(Array,"scopesList should be a list of scopes name defined from descriptor");
            User.scopesList.should.be.eql(_.keys(User.scopes),"Should be list of scopes defined in model descriptor");
